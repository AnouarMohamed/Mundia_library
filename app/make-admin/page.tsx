            ...
            <Card className="border-2 border-gray-600 bg-gray-800/30">
              ...
              <CardContent className="space-y-4 sm:space-y-6">
                      ...
                      <div className="ml-2 sm:ml-3">
                        ...
                        <div className="mt-1.5 text-xs text-red-300 sm:mt-2 sm:text-sm">
                          <p>
                            ...
                            {params.error === "db-unavailable" &&
                              "Database is temporarily unavailable. Please check DATABASE_URL or your network, then try again."}
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                >
                  ...
                  <Button
                    type="submit"
                    className="w-full bg-slate-700 text-xs text-white hover:bg-slate-800 sm:text-sm"
                  >
