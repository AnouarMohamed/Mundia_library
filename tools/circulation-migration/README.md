...
- Apply requires PostgreSQL 18 and exactly successful circulation Flyway
  versions 1 through 5. It validates the target column signature, validated
...
CI must provision that fresh database, run circulation Flyway 1 through 5, and
...
Apply the circulation service's reviewed Flyway migrations 1 through 5 to a
