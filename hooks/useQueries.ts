...
export const useAllUsers = (
  ...
  return useQuery({
    ...
    staleTime: 30 * 1000, // Keep admin list filters snappy during quick navigation
...
export const usePendingUsers = (
  ...
  return useQuery({
    ...
    staleTime: 30 * 1000, // Avoid repeated refetches while typing/navigating
    refetchOnMount: true, // Refetch on mount
    initialData, // Use SSR data if provided (prevents duplicate fetch)
  });
};
...
export const useUserBorrows = (
  ...
  // Keep SSR hydration behavior, but allow short-lived caching to avoid
  // unnecessary refetches on every navigation.
  ...
  return useQuery({
    ...
    refetchOnMount: true, // Refetch after data becomes stale or is invalidated
...
export const useBorrowRequests = (
  ...
  return useQuery({
    ...
    staleTime: 30 * 1000, // Keep recent admin data warm between quick tab changes
    refetchOnMount: true, // Refetch on mount
    initialData, // Use SSR data if provided (prevents duplicate fetch)
  });
};
