...
const AdminDropdown = () => {
  ...
  return (
    ...
    >
      ...
      {/* Dropdown Menu */}
      {isOpen && (
        <div className="absolute left-0 top-full z-50 mt-2 w-44 rounded-2xl border border-white/10 bg-[rgba(7,14,22,0.96)] p-1.5 shadow-2xl backdrop-blur-xl sm:w-52">
